...
// Mints the X-Service-Token core-banking attaches to its calls into identity-service's
// /internal/** endpoints (see KycStatusClient, DataSeeder)
@Component
public class InternalServiceTokenIssuer {

    private static final String ISSUER_KID = "core-banking";
